...
class ProcessingResult:
    """کلاس نگهداری نتایج پردازش متن"""

    text: str  # متن اصلی
    tokens: List[str]  # توکن‌های متن
    confidence: float  # میزان اطمینان به تحلیل (0 تا 1)
    language: str  # زبان متن
    analysis_time: datetime  # زمان تحلیل
    ...
    def merge_with(self, other: 'ProcessingResult') -> 'ProcessingResult':
